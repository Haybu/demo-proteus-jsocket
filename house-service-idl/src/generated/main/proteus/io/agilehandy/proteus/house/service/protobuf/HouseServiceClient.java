...
public final class HouseServiceClient implements HouseService {
  ...
  private final java.util.function.Function<? super org.reactivestreams.Publisher<io.agilehandy.proteus.house.service.protobuf.HouseResponse>, ? extends org.reactivestreams.Publisher<io.agilehandy.proteus.house.service.protobuf.HouseResponse>> getAllHouses;
  private final java.util.function.Function<? super org.reactivestreams.Publisher<io.agilehandy.proteus.house.service.protobuf.Identifier>, ? extends org.reactivestreams.Publisher<io.agilehandy.proteus.house.service.protobuf.Identifier>> addHouse;
  ...
  private final java.util.function.Function<java.util.Map<String, String>, java.util.function.Function<? super org.reactivestreams.Publisher<io.agilehandy.proteus.house.service.protobuf.HouseResponse>, ? extends org.reactivestreams.Publisher<io.agilehandy.proteus.house.service.protobuf.HouseResponse>>> getAllHousesTrace;
  private final java.util.function.Function<java.util.Map<String, String>, java.util.function.Function<? super org.reactivestreams.Publisher<io.agilehandy.proteus.house.service.protobuf.Identifier>, ? extends org.reactivestreams.Publisher<io.agilehandy.proteus.house.service.protobuf.Identifier>>> addHouseTrace;
  ...
  public HouseServiceClient(io.rsocket.RSocket rSocket) {
    ...
    this.getAllHousesTrace = io.netifi.proteus.tracing.ProteusTracing.trace();
    this.addHouseTrace = io.netifi.proteus.tracing.ProteusTracing.trace();
  }
  ...
  public HouseServiceClient(io.rsocket.RSocket rSocket, io.micrometer.core.instrument.MeterRegistry registry) {
    ...
    this.getAllHouses = io.netifi.proteus.metrics.ProteusMetrics.timed(registry, "proteus.client", "service", HouseService.SERVICE, "method", HouseService.METHOD_GET_ALL_HOUSES);
    this.addHouse = io.netifi.proteus.metrics.ProteusMetrics.timed(registry, "proteus.client", "service", HouseService.SERVICE, "method", HouseService.METHOD_ADD_HOUSE);
    this.getHouseTrace = io.netifi.proteus.tracing.ProteusTracing.trace();
    this.getHousesByRoomsTrace = io.netifi.proteus.tracing.ProteusTracing.trace();
    this.getHousesByBathsTrace = io.netifi.proteus.tracing.ProteusTracing.trace();
    this.getHousesByLotsizeTrace = io.netifi.proteus.tracing.ProteusTracing.trace();
  ...
  public HouseServiceClient(io.rsocket.RSocket rSocket, io.opentracing.Tracer tracer) {
    ...
    this.getAllHousesTrace = io.netifi.proteus.tracing.ProteusTracing.trace(tracer, HouseService.METHOD_GET_ALL_HOUSES, io.netifi.proteus.tracing.Tag.of("proteus.service", HouseService.SERVICE), io.netifi.proteus.tracing.Tag.of("proteus.type", "client"), io.netifi.proteus.tracing.Tag.of("proteus.version", "0.8.9"));
    this.addHouseTrace = io.netifi.proteus.tracing.ProteusTracing.trace(tracer, HouseService.METHOD_ADD_HOUSE, io.netifi.proteus.tracing.Tag.of("proteus.service", HouseService.SERVICE), io.netifi.proteus.tracing.Tag.of("proteus.type", "client"), io.netifi.proteus.tracing.Tag.of("proteus.version", "0.8.9"));
  }
  ...
  @io.netifi.proteus.annotations.internal.ProteusGeneratedMethod(returnTypeClass = io.agilehandy.proteus.house.service.protobuf.HouseResponse.class)
  public reactor.core.publisher.Flux<io.agilehandy.proteus.house.service.protobuf.HouseResponse> getAllHouses(io.agilehandy.proteus.house.service.protobuf.Empty message) {
    return getAllHouses(message, io.netty.buffer.Unpooled.EMPTY_BUFFER);
  }

  @java.lang.Override
  @io.netifi.proteus.annotations.internal.ProteusGeneratedMethod(returnTypeClass = io.agilehandy.proteus.house.service.protobuf.HouseResponse.class)
  public reactor.core.publisher.Flux<io.agilehandy.proteus.house.service.protobuf.HouseResponse> getAllHouses(io.agilehandy.proteus.house.service.protobuf.Empty message, io.netty.buffer.ByteBuf metadata) {
  java.util.Map<String, String> map = new java.util.HashMap<>();
    return reactor.core.publisher.Flux.defer(new java.util.function.Supplier<reactor.core.publisher.Flux<io.rsocket.Payload>>() {
      @java.lang.Override
      public reactor.core.publisher.Flux<io.rsocket.Payload> get() {
        final io.netty.buffer.ByteBuf tracingMetadata = io.netifi.proteus.tracing.ProteusTracing.mapToByteBuf(io.netty.buffer.ByteBufAllocator.DEFAULT, map);
        final io.netty.buffer.ByteBuf metadataBuf = io.netifi.proteus.frames.ProteusMetadata.encode(io.netty.buffer.ByteBufAllocator.DEFAULT, HouseService.SERVICE, HouseService.METHOD_GET_ALL_HOUSES, tracingMetadata, metadata);
        io.netty.buffer.ByteBuf data = serialize(message);
        tracingMetadata.release();
        return rSocket.requestStream(io.rsocket.util.ByteBufPayload.create(data, metadataBuf));
      }
    }).map(deserializer(io.agilehandy.proteus.house.service.protobuf.HouseResponse.parser())).transform(getAllHouses).transform(getAllHousesTrace.apply(map));
  }
  ...
  public reactor.core.publisher.Mono<io.agilehandy.proteus.house.service.protobuf.Identifier> addHouse(io.agilehandy.proteus.house.service.protobuf.HouseRequest message) {
    return addHouse(message, io.netty.buffer.Unpooled.EMPTY_BUFFER);
  }

  @java.lang.Override
  @io.netifi.proteus.annotations.internal.ProteusGeneratedMethod(returnTypeClass = io.agilehandy.proteus.house.service.protobuf.Identifier.class)
  public reactor.core.publisher.Mono<io.agilehandy.proteus.house.service.protobuf.Identifier> addHouse(io.agilehandy.proteus.house.service.protobuf.HouseRequest message, io.netty.buffer.ByteBuf metadata) {
  java.util.Map<String, String> map = new java.util.HashMap<>();
    return reactor.core.publisher.Mono.defer(new java.util.function.Supplier<reactor.core.publisher.Mono<io.rsocket.Payload>>() {
      @java.lang.Override
      public reactor.core.publisher.Mono<io.rsocket.Payload> get() {
        final io.netty.buffer.ByteBuf tracingMetadata = io.netifi.proteus.tracing.ProteusTracing.mapToByteBuf(io.netty.buffer.ByteBufAllocator.DEFAULT, map);
        final io.netty.buffer.ByteBuf metadataBuf = io.netifi.proteus.frames.ProteusMetadata.encode(io.netty.buffer.ByteBufAllocator.DEFAULT, HouseService.SERVICE, HouseService.METHOD_ADD_HOUSE, tracingMetadata, metadata);
        io.netty.buffer.ByteBuf data = serialize(message);
        tracingMetadata.release();
        return rSocket.requestResponse(io.rsocket.util.ByteBufPayload.create(data, metadataBuf));
      }
    }).map(deserializer(io.agilehandy.proteus.house.service.protobuf.Identifier.parser())).transform(addHouse).transform(addHouseTrace.apply(map));
  }
